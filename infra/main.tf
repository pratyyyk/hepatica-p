    ...
    image_repository {
      ...
      image_configuration {
        ...
        runtime_environment_variables = {
          ...
          STAGE1_MODEL_ARTIFACT_DIR    = "/app/ml/artifacts/stage1"
          STAGE2_REQUIRE_MODEL_NON_DEV = "true"
          STAGE2_REGISTRY_MODEL_NAME   = "fibrosis-efficientnet-b3"
          MODEL_ARTIFACT_PATH          = "/app/ml/artifacts/fibrosis_model.pt"
          TEMPERATURE_ARTIFACT_PATH    = "/app/ml/artifacts/temperature_scaling.json"
